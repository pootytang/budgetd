defmodule Mimo.BudgetPeriodTest do
  use Budgetd.DataCase, async: true

  alias Budgetd.Mimo.BudgetPeriod

  describe "changeset/2" do
    test "failes when start date is after the beginning of the month" do
    ...
    test "fails with end date is before the end of the month" do
