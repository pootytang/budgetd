defmodule BudgetdWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BudgetdWeb.Gettext
  ...
  def dropdown_menu(assigns) do
    ...
    >
      <button
        ...
        class="p-2 hover:bg-gray-300 dark:hover:bg-gray-700 rounded-full text-gray-500"
      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BudgetdWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BudgetdWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def footer(assigns) do
    ...
    <footer class="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
      ...
      <aside>
        <p>Copyright © 2025 - All right reserved by Gelanez LLC</p>
      </aside>
    </footer>
    """
  end
  ...
  attr :onclose, :map, doc: "Map to call when the modal close button is clicked"
  attr :id, :string, required: true
    ...
    <dialog id={@id} title="Create Budget" on_cancel={@on_cancel} class="modal modal-open">
      <div class="modal-box">
        <form method="dialog" class="modal-backdrop">
          <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" phx-click={@onclose}>
            ✕
          </button>
        </form>
