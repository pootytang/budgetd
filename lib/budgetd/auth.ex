defmodule Budgetd.Auth do
  ...
  alias Budgetd.Auth.{User, UserToken, UserNotifier}
  ...
  See `Budgetd.Auth.User.email_changeset/3` for a list of supported options.
  ...
  See `Budgetd.Auth.User.password_changeset/3` for a list of supported options.
